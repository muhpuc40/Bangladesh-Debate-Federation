    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-xl p-6 text-white">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div>
            ...
            <p className="opacity-90">Your debate journey continues. Check out your latest updates below.</p>
          </div>
      ...
      <div className="bg-white rounded-xl border border-emerald-100 p-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-xl font-bold text-emerald-900">Progress to {user.nextLevel} Level</h3>
          <span className="text-emerald-600 font-bold">{user.progress}%</span>
        </div>
        ...
        <div className="flex justify-between text-sm text-gray-600 mt-2">
          ...
          <span>3,000 points needed for {user.nextLevel}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-xl border border-emerald-100 p-6">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-bold text-emerald-900">Upcoming Events</h3>
            <Link to="/events" className="text-emerald-600 hover:text-emerald-800 font-bold text-sm flex items-center">
            ...
            {upcomingEvents.map(event => (
              <div key={event.id} className="flex items-center justify-between p-4 border border-emerald-100 rounded-lg hover:bg-emerald-50 transition-all duration-300">
                <div>
                  ...
                  <div className="text-sm text-gray-600">{event.date} • {event.team || event.location}</div>
                </div>
        ...
        <div className="bg-white rounded-xl border border-emerald-100 p-6">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-bold text-emerald-900">Recent Achievements</h3>
            <Link to="/achievements" className="text-emerald-600 hover:text-emerald-800 font-bold text-sm flex items-center">
              View All <FaArrowRight className="ml-1" />
            </Link>
          </div>
          <div className="space-y-4">
            {achievements.map((achievement, index) => (
              <div key={index} className="flex items-center p-4 border border-emerald-100 rounded-lg hover:bg-emerald-50 transition-all duration-300">
                ...
                <div>
                  <h4 className="font-bold text-emerald-900">{achievement.title}</h4>
      ...
      {/* Quick Actions */}
      <div className="bg-white rounded-xl border border-emerald-100 p-6">
        <h3 className="text-xl font-bold text-emerald-900 mb-6">Quick Actions</h3>
    ...
    <div className="space-y-8">
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex items-center justify-center md:justify-start mb-4">
              <span className="bg-emerald-800 px-3 py-1 rounded-full text-sm mr-3">{user.role}</span>
              <span className="bg-emerald-800 px-3 py-1 rounded-full text-sm">{user.level} Level</span>
            </div>
            <p className="opacity-90">
              <span className="block">📧 {user.email}</span>
              <span className="block">🏫 {user.institution}</span>
              <span className="block">📅 Member since {user.memberSince}</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-xl border border-emerald-100 p-6">
            <h3 className="text-xl font-bold text-emerald-900 mb-6">Personal Information</h3>
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-center justify-between py-3 border-b border-emerald-50">
                  <div>
                    ...
                    <div className="font-medium text-emerald-900">{field.value}</div>
                  </div>
                  {field.editable && (
                    <button className="text-emerald-600 hover:text-emerald-800">
                      <FaEdit />
          ...
          {/* Debate Information */}
          <div className="bg-white rounded-xl border border-emerald-100 p-6">
            <h3 className="text-xl font-bold text-emerald-900 mb-6">Debate Information</h3>
            <div className="space-y-4">
              {[
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-xl p-6 text-white">
            <div className="flex items-center justify-between mb-6">
              <div>
                <div className="text-sm opacity-90">Membership ID</div>
                <div className="text-xl font-bold">BDF-2022-0456</div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold">Dec 31, 2024</span>
              </div>
              <div className="flex justify-between">
          ...
          {/* Badges */}
          <div className="bg-white rounded-xl border border-emerald-100 p-6">
            <h3 className="text-xl font-bold text-emerald-900 mb-6">Badges</h3>
  ...
  const renderEvents = () => (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-emerald-900">My Events</h2>
          <p className="text-gray-600">Manage your event registrations and participation</p>
        </div>
        <Link 
          to="/events" 
        ...
        >
          <FaCalendarAlt className="mr-2" /> Browse Events
        </Link>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-emerald-50">
              <tr>
                <th className="py-4 px-6 text-left font-bold text-emerald-900">Event</th>
                <th className="py-4 px-6 text-left font-bold text-emerald-900">Date</th>
                <th className="py-4 px-6 text-left font-bold text-emerald-900">Type</th>
                <th className="py-4 px-6 text-left font-bold text-emerald-900">Status</th>
                <th className="py-4 px-6 text-left font-bold text-emerald-900">Actions</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={event.id} className="border-b border-emerald-50 hover:bg-emerald-50 transition-colors duration-300">
                  <td className="py-4 px-6">
                    <div className="font-bold text-emerald-900">{event.title}</div>
                    <div className="text-sm text-gray-600">{event.team || event.result}</div>
                  </td>
          ...
          <div className="lg:w-64 flex-shrink-0">
            <div className="bg-white rounded-xl border border-emerald-100 p-6 mb-6">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <div className="font-bold text-emerald-900">{user.name}</div>
            ...
            <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-xl p-6 text-white">
              <div className="text-center mb-4">
                ...
                <div className="opacity-90">Debate Points</div>
              </div>
              <div className="space-y-3">
